...
//Configuração do service de moderação de conteúdo - AZURE
//chave e Endpoint obtidos na Azure

builder.Services.AddSingleton(provider => new ContentModeratorClient(
 new ApiKeyServiceClientCredentials("876f9be650f44e64b1b8f1137c22cd48"))
{
    Endpoint = "https://eventmoderator-kamille.cognitiveservices.azure.com/"
}
